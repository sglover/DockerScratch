...
DEPRECATION_WARNING="deprecated in Flocker 1.14.0 and will be removed in future versions of Flocker. Use the official installation methods and tools instead. See https://docs.clusterhq.com."
